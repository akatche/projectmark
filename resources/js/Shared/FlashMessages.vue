<template>
    <div>
        <div v-if="$page.flash.success && show" class="mb-8 flex items-center justify-between bg-green-500">
          <div class="flex items-center">
            ...
            <div class="py-4 text-white text-sm font-medium" data-cy="flash-message">{{ $page.flash.success }}</div>
          </div>
        ...
        <div v-if="($page.flash.error || Object.keys($page.errors).length > 0) && show" class="mb-8 flex items-center justify-between bg-red-500" data-cy="flash-message">
      <div class="flex items-center">
